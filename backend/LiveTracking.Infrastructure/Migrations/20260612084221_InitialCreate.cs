        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAscentMeters = table.Column<double>(type: "double precision", nullable: true),
                    TotalDescentMeters = table.Column<double>(type: "double precision", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorDevices_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareHeartRate = table.Column<bool>(type: "boolean", nullable: false),
                    ShareSpeed = table.Column<bool>(type: "boolean", nullable: false),
                    ShareDistance = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDistanceMeters = table.Column<double>(type: "double precision", nullable: false),
                    AverageSpeedKmh = table.Column<double>(type: "double precision", nullable: true),
                    MaxSpeedKmh = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistanceFromStartMeters = table.Column<double>(type: "double precision", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityPoints_Activities_ActivityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PublicSessionId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LiveSessions_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeedKmh = table.Column<double>(type: "double precision", nullable: true),
                    DistanceCompletedMeters = table.Column<double>(type: "double precision", nullable: false),
                    DistanceRemainingMeters = table.Column<double>(type: "double precision", nullable: true),
                    RouteProgressPercent = table.Column<double>(type: "double precision", nullable: true),
                    HeartRateBpm = table.Column<int>(type: "integer", nullable: true),
                    CadenceRpm = table.Column<int>(type: "integer", nullable: true),
                    PowerWatts = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveSnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveSnapshots_LiveSessions_LiveSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityPoints_ActivityId",
                table: "ActivityPoints",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityPoints_Timestamp",
                table: "ActivityPoints",
                column: "Timestamp");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LiveSessions_ActivityId",
                table: "LiveSessions",
                column: "ActivityId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LiveSessions_IsPublic",
                table: "LiveSessions",
                column: "IsPublic");

            migrationBuilder.CreateIndex(
                name: "IX_LiveSessions_PublicSessionId",
                table: "LiveSessions",
                column: "PublicSessionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LiveSnapshots_LiveSessionId",
                table: "LiveSnapshots",
                column: "LiveSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveSnapshots_PublicSessionId",
                table: "LiveSnapshots",
                column: "PublicSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveSnapshots_TimestampUtc",
                table: "LiveSnapshots",
                column: "TimestampUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorDevices_UserId_DeviceId",
                table: "SensorDevices",
